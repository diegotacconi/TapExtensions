...
namespace TapExtensions.Instruments.Switch
{
    ...
    public class SwitchGroup : Instrument, ISwitch
    {
        ...
        private static Dictionary<string, string> _routeGroups = new Dictionary<string, string>
        {
            ...
            { "Rf9",  "AppSsu4., PxiDio.Cto3" },
            { "Rf10", "AppSsu4., PxiDio.Cto3" },
            { "Rf11", "AppSsu4., PxiDio.Cto3" },
            { "Rf12", "AppSsu4., PxiDio.Cto3" },
            { "Rf13", "AppSsu4., PxiDio.Cto3" },
            { "Rf14", "AppSsu4., PxiDio.Cto3" },
            { "Rf15", "AppSsu4., PxiDio.Cto3" },
            { "Rf16", "AppSsu4.ANT8toSA, PxiDio.Cto3" },

            // DownLink B1B3
            { "Rf17", "AppSsu1., PxiDio.Cto2" },
            { "Rf18", "AppSsu1., PxiDio.Cto2" },
            { "Rf19", "AppSsu1., PxiDio.Cto2" },
            { "Rf20", "AppSsu1., PxiDio.Cto2" },
            { "Rf21", "AppSsu1., PxiDio.Cto2" },
            { "Rf22", "AppSsu1., PxiDio.Cto2" },
            { "Rf23", "AppSsu1., PxiDio.Cto2" },
            { "Rf24", "AppSsu1., PxiDio.Cto2" },

            { "Rf25", "AppSsu4., PxiDio.Cto3" },
            { "Rf26", "AppSsu4., PxiDio.Cto3" },
            { "Rf27", "AppSsu4., PxiDio.Cto3" },
            { "Rf28", "AppSsu4., PxiDio.Cto3" },
            { "Rf29", "AppSsu4., PxiDio.Cto3" },
            { "Rf30", "AppSsu4., PxiDio.Cto3" },
            { "Rf31", "AppSsu4., PxiDio.Cto3" },
            { "Rf32", "AppSsu4., PxiDio.Cto3" },

            // DownLink B1B3
            { "Rf65", "AppSsu2.ANT16toSA, PxiDio.Cto1" },
            { "Rf66", "AppSsu2., PxiDio.Cto1" },
            { "Rf67", "AppSsu2., PxiDio.Cto1" },
            { "Rf68", "AppSsu2., PxiDio.Cto1" },
            { "Rf69", "AppSsu2., PxiDio.Cto1" },
            { "Rf70", "AppSsu2., PxiDio.Cto1" },
            { "Rf71", "AppSsu2., PxiDio.Cto1" },
            { "Rf72", "AppSsu2., PxiDio.Cto1" },

            { "Rf73", "AppSsu3., PxiDio.Cto4" },
            { "Rf74", "AppSsu3., PxiDio.Cto4" },
            { "Rf75", "AppSsu3., PxiDio.Cto4" },
            { "Rf76", "AppSsu3., PxiDio.Cto4" },
            { "Rf77", "AppSsu3., PxiDio.Cto4" },
            { "Rf78", "AppSsu3., PxiDio.Cto4" },
            { "Rf79", "AppSsu3., PxiDio.Cto4" },
            { "Rf80", "AppSsu3., PxiDio.Cto4" },

            // DownLink B7
            { "Rf81", "AppSsu2., PxiDio.Cto1" },
            { "Rf82", "AppSsu2., PxiDio.Cto1" },
            { "Rf83", "AppSsu2., PxiDio.Cto1" },
            { "Rf84", "AppSsu2., PxiDio.Cto1" },
            { "Rf85", "AppSsu2., PxiDio.Cto1" },
            { "Rf86", "AppSsu2., PxiDio.Cto1" },
            { "Rf87", "AppSsu2., PxiDio.Cto1" },
            { "Rf88", "AppSsu2., PxiDio.Cto1" },

            { "Rf89", "AppSsu3., PxiDio.Cto4" },
            { "Rf90", "AppSsu3.ANT7toSA, PxiDio.Cto4" },
            { "Rf91", "AppSsu3., PxiDio.Cto4" },
            { "Rf92", "AppSsu3., PxiDio.Cto4" },
            { "Rf93", "AppSsu3., PxiDio.Cto4" },
            { "Rf94", "AppSsu3., PxiDio.Cto4" },
            { "Rf95", "AppSsu3., PxiDio.Cto4" },
            { "Rf96", "AppSsu3., PxiDio.Cto4" }
